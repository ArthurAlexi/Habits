        ...
        <div className='w-full max-w-3xl mx-auto flex items-center justify-between'>
            ...
            <Dialog.Root>
                ...
                <Dialog.Portal>
                    ...
                    <Dialog.Content className='absolute solid p-10 bg-zinc-900 rounded-2xl
                     w-full max-w-sm top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2'>
                        <Dialog.Close
                        ...
                        <Dialog.Title className='text-2xl leading-tight font-extrabold '>Criar Hábito</Dialog.Title>
                        <NewHabitForm />
                    </Dialog.Content>
                </Dialog.Portal>
            </Dialog.Root>
